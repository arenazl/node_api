...
const ThemeManager = {
    ...
    setTheme: function(themeName) {
        ...
        if (themeName === 'light') {
            this._applyLightThemeStyles();
        } else {
            this._removeLightThemeStyles();
        }
    ...
    _applyLightThemeStyles: function() {
        ...
        style.id = styleId;
        style.innerHTML = `
            .theme-light .main-tab-btn.active {
                background-color: #ffffff !important;
                border-top-left-radius: 0.375rem;
                border-top-right-radius: 0.375rem;
                transform: translateY(2px);
            }
            .theme-light .subtab-btn.active {
                background-color: #ffffff !important;
                border-top-left-radius: 0.375rem;
                border-top-right-radius: 0.375rem;
                transform: translateY(1px);
            }
            .theme-light .json-container,
            .theme-light pre.json-editor,
            .theme-light #streamData,
            .theme-light #fixedStringOutput {
                background-color: var(--bg-editors) !important;
            }
            .theme-light .container {
                background-color: #f8f9fa !important;
            }
            .theme-light .service-panel, .theme-light .file-upload {
                background-color: #ffffff !important;
    ...
    _removeLightThemeStyles: function() {
        const styleElement = document.getElementById('light-theme-overrides');
        if (styleElement) {
            styleElement.remove();
        }
    },
